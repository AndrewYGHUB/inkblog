...
```sh
git config --global core.hooksPath C:/Users/AndrewYG/git-hooks
```
...
Add correct host key in /c/Users/andrewyghub/.ssh/known_hosts to get rid of this message.
Offending ECDSA key in /c/Users/andrewyghub/.ssh/known_hosts:1
