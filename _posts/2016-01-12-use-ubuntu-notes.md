...
```
export ANDROID_SDK_HOME=/home/andrewyghub/android/sdk
...
Exec=/home/andrewyghub/android/eclipse/eclipse
Icon=/home/andrewyghub/android/eclipse/icon.xpm
StartupNotify=true
Terminal=false
Type=Application
```
...
```sh
andrewyghub@ubuntu:~$ ll ~/.ssh
total 20
drwx------  2 andrewyghub andrewyghub 4096 Jun 22 01:03 ./
drwxr-xr-x 20 andrewyghub andrewyghub 4096 Jun 22 01:02 ../
-rw-------  1 andrewyghub andrewyghub 1679 Jun 21 05:17 id_rsa
-rw-r--r--  1 andrewyghub andrewyghub  399 Jun 21 05:17 id_rsa.pub
```
