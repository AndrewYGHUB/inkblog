...
1. 在你的 vimrc 文件中添加如下内容：
   ...
   ```markdown
   Plugin 'andrewyghub/vim-kramdown-tab'
   ```
...
[1]: https://andrewyghub.github.io/2016/02/04/switch-to-kramdown-from-redcarpet/
[2]: https://github.com/andrewyghub/vim-kramdown-tab
[3]: http://github.com/VundleVim/Vundle.Vim
[4]: https://raw.githubusercontent.com/andrewyghub/vim-kramdown-tab/master/screenshots/test.gif
