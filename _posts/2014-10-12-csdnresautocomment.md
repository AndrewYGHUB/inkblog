...
GitHub 仓库地址：<https://github.com/andrewyghub/csdncommenter>
...
遂在 GitHub 上建了个仓库开工，地址在这里：<https://github.com/andrewyghub/csdncommenter>。
...
（GitHub 仓库：[andrewyghub/csdncommenter](https://github.com/andrewyghub/csdncommenter)，现在可以通过 pip 安装使用了  `pip install csdncommenter`  然后  `csdncommenter`。2015/10/27 update）

```python
# File   : csdncommenter.py
# Author : AndrewYG
# E-mail : chumpma(at)gmail.com
# Website: https://andrewyghub.github.io
# Date   : 2016-07-26
import requests
